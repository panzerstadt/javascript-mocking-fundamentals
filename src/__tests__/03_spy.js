...
// spying only spies on one part of a module
// and it only works in commonjs
// to mock entire modules, check inline-modules.js

test("returns winner", () => {
  jest.spyOn(utils, "getWinner"); // to not have to monkey patch manually
